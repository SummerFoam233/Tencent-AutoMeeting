...
"")
        ...
        self.gridLayout.addWidget(self.tmp_auto_course_pbt, 2, 0, 1, 1)
...
"}")
        ...
        self.NameLE = QtWidgets.QLineEdit(self.frame_2)
        self.NameLE.setObjectName("NameLE")
        self.gridLayout_2.addWidget(self.NameLE, 1, 1, 1, 1)
        self.label_3 = QtWidgets.QLabel(self.frame_2)
        self.label_3.setObjectName("label_3")
        self.gridLayout_2.addWidget(self.label_3, 2, 0, 1, 1)
        self.MetIDLE = QtWidgets.QLineEdit(self.frame_2)
        self.MetIDLE.setObjectName("MetIDLE")
        self.gridLayout_2.addWidget(self.MetIDLE, 0, 1, 1, 1)
        self.label_2 = QtWidgets.QLabel(self.frame_2)
        self.label_2.setObjectName("label_2")
        self.gridLayout_2.addWidget(self.label_2, 0, 0, 1, 1)
        self.StartTimeLE = QtWidgets.QLineEdit(self.frame_2)
        self.StartTimeLE.setObjectName("StartTimeLE")
        self.gridLayout_2.addWidget(self.StartTimeLE, 2, 1, 1, 1)
